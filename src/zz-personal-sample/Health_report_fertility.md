...
**Test:** Semen Analysis (23/08/2025)  

**Results:**
- **Sperm Count:** 80 million/ml (Normal: >15 million/ml) ✅ Excellent  
- **Active Motility:** 40% (Normal: >32%) ✅ Normal  
- **Normal Morphology:** 40% (Normal: >4%) ✅ Excellent  
- **Pus Cells:** 0/HPF ✅ No infection  
- **Other Parameters:** Normal  

**Conclusion:**  
**Normozoospermia → Fertility normal, no treatment needed.**

---

## 👩 Wife (Fatema, Age 33)

### 🔹 Test 1: Haematology (19/08/2025)
- **Hemoglobin:** 12.7 g/dL (Normal: 12–16) ✅ Normal  
- **WBC, RBC, Platelets:** Within normal range  
- **ESR:** 25 mm/hr ⚠️ Slightly high (may indicate mild inflammation, not a major fertility issue)  

**Conclusion:**  
Blood report essentially normal.

---

### 🔹 Test 2: Hormone Assay – Prolactin (19/08/2025)
- **Result:** 48.0 ng/ml  
- **Normal Range (Female, pre-menopausal):** 3.8 – 30.7 ng/ml  
- **Condition:** **Hyperprolactinemia (High Prolactin)**  

**Effect on Fertility:**  
- Suppresses ovulation (no egg release)  
- Causes irregular or absent periods  
- Reduces chances of conception  

---

## 📊 Overall Couple Analysis

- **Husband:** Fertility parameters normal.  
- **Wife:** Main issue = High Prolactin (Hyperprolactinemia).  
- **Good News:** This condition is **treatable** with medication (e.g., Cabergoline or Bromocriptine, prescribed by doctor).  
- Once prolactin normalizes, ovulation resumes → pregnancy chances rise significantly.  
...
- Repeat **Prolactin test** (morning, fasting, stress-free).  
- Check **Thyroid function (TSH, Free T4)** – thyroid problems can also increase prolactin.  

### Step 2: Consult Doctor
- Visit **Gynecologist or Endocrinologist**.  
- Possible prescribed medicines:  
  - **Cabergoline (Dostinex)** OR  
  - **Bromocriptine**  
- Doctor will decide dosage (⚠️ do not self-medicate).  

### Step 3: Monitoring
- Recheck **Prolactin every 4–6 weeks**.  
- Usually normalizes in 2–3 months.  
- Periods become regular → sign of ovulation returning.  

### Step 4: Conception Timing
- After normalization, try conception.  
- Best time: **Day 11–18 of menstrual cycle** (every 2 days intercourse).  

### Step 5: Extra Tests (if needed)
- **Pelvic Ultrasound:** To check ovulation.  
- **Pituitary MRI:** If prolactin remains very high (>100 ng/ml).  

### Step 6: Lifestyle Tips
- Reduce **stress**.  
- Maintain **7–8 hrs sleep**.  
- Balanced diet: vegetables, fruits, protein (fish, chicken, eggs, lentils).  
...
- **Husband:** Normal fertility, no issues.  
- **Wife:** Has **treatable hormonal imbalance (high prolactin)**.  
